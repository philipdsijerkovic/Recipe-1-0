export default function App() {
  return (
    <nav
    className="block w-full max-w-screen-xl px-4 py-2 mx-auto text-black bg-transparent lg:px-8 lg:py-4">
  <div className="container flex items-center justify-between mx-auto text-blue-gray-900">
    <a href="/"
      className="mr-4 block cursor-pointer py-1.5 font-sans text-gradient text-base font-medium leading-relaxed text-inherit antialiased">
      Recipe 1.0
    </a>
