...
function Card() {
  return (
    <div className="max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-800 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105" style={{ marginTop: '-25px' }}>
      <img className="w-full h-56 object-cover object-center" src="./src/assets/Apple-Pie-Recipe-Video.jpg" alt="apple pie" />
  ...
  <div className="mt-2 mx-4 p-4 bg-gradient-to-r from-blue-100 via-blue-200 to-blue-300 rounded-lg shadow-md mb-10"> {/* Adjusted gradient */}
